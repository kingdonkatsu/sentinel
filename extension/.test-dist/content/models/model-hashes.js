...
exports.MODEL_HASHES = void 0;
exports.shouldVerify = shouldVerify;
/**
 ...
 */
function shouldVerify(modelPath) {
    return (exports.MODEL_HASHES[modelPath] ?? "").length > 0;
}
